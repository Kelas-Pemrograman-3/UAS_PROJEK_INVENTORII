   ...
   <q-dialog v-model="openedit" v-if="openedit">
      <q-card style="width: 700px; max-width:80vw;">
        ...
        <q-separator/>
          ...
          <q-input label ="Tanggal Masuk" v-model ="activedata.Tanggal_Keluar"></q-input>
          <q-input label ="Tanggal Keluar" v-model ="activedata.Tanggal_Keluar"></q-input>
          <q-input label ="Stok Barang" v-model ="activedata.Stok"></q-input>
          </q-card-selection>
...
export default {
  ...
  methods: {
    ...
    edit () {
      this.$axios.put('hotel/edit/' + this.activedata._id, this.activedata)
        .then(res => {
          if (res.data.error) {

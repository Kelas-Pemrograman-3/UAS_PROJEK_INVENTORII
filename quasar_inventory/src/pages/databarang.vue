   ...
   <q-dialog v-model="openedit" v-if="openedit">
      <q-card style="width: 700px; max-width:80vw;">
        ...
        <q-separator/>
          ...
          <q-input label ="Nama Barang" v-model ="activedata.Nama_Barang"></q-input>
          <q-input label ="Tanggal Masuk Masuk" v-model ="activedata.Tanggal_Masuk"></q-input>
          <q-input label ="Tanggal Keluar Barang" v-model ="activedata.Tanggal_Keluar"></q-input>
...
export default {
  ...
  methods: {
    getData () {
      this.$axios.get('inputbarang/getAll')
        .then(res => {
